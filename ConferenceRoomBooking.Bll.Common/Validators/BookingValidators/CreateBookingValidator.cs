...
namespace ConferenceRoomBooking.Services.API.DTOs.BookingRequest.Validators
{
    public class CreateBookingValidator : AbstractValidator<Booking>
    {
        ...
        private bool IsWithinAllowedTimeRange(Booking dto, TimeSpan allowedStartTime, TimeSpan allowedEndTime)
        {
